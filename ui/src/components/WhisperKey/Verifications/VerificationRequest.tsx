  ...
  return (
      ...
      <div className='grid grid-cols-1 space-y-6'>
        <div className="form-control">
          ...
          <input type="text" id="name" onChange={handleVCNameChange} className="max-w-xs w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
        ...
        <div className="form-control">
          ...
          <input type="text" id="name" onChange={handleVCDescriptionChange} className="max-w-xs w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" placeholder="Enter a description" />
        </div>
          ...
          {rows.map((row, index) => (
            <div key={row.id} className="form-row grid grid-cols-4 gap-4">
              ...
              <div className="form-control">
                ...
                <select
                  className="select max-w-xs w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  value={row.type}
